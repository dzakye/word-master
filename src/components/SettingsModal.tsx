  ...
  return (
    ...
    >
      <div className={`h-full ${darkMode ? 'dark' : ''}`}>
        ...
        >
          <h1 className="text-center mb-4 sm:text-3xl text-2xl">Réglâdzó</h1>
          <div className="flex-1 w-full border-b border-slate-400 mb-4">
            ...
            <RadioGroup value={difficultyLevel} onChange={setDifficultyLevel} className="mt-6">
              <RadioGroup.Label className="w-full text-center">Grâda dé dificolta</RadioGroup.Label>
          ...
          <div className="flex flex-col items-center">
            ...
            >
              <img
                ...
                src="https://img.buymeacoffee.com/button-api/?text=Paé mé oun caféi&emoji=&slug=katherinecodes&button_colour=eab308&font_colour=000000&font_family=Cookie&outline_colour=000000&coffee_colour=ffffff"
              />
            </a>
          </div>
        </div>
